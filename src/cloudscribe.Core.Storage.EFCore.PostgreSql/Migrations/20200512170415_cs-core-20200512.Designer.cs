...
namespace cloudscribe.Core.Storage.EFCore.PostgreSql.Migrations
{
    ...
    [Migration("20200512170415_cs-core-20200512")]
    partial class cscore20200512
    {
            ...
            modelBuilder.Entity("cloudscribe.Core.Models.SiteUser", b =>
                {
                    ...
                    b.HasIndex("NormalizedEmail", "SiteId")
                        .IsUnique()
                        .HasName("ix_cs_user_normalized_email_site_id");

                    b.HasIndex("NormalizedUserName", "SiteId")
                        .IsUnique()
                        .HasName("ix_cs_user_normalized_user_name_site_id");
